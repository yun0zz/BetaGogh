...
import com.example.homeactivity.Share.GalleryFragment;
import com.example.homeactivity.Share.NextActivity;
import com.example.homeactivity.Share.PhotoFragment;
...
public class FirebaseMethods {
    ...
    public void uploadNewPhoto(String photoType, final String caption, final int count, final String imgUrl,
        ...
        if (photoType.equals(mContext.getString(R.string.new_photo))) {
            ...
            if (bm == null){
                ...
                Log.d(TAG, "uploadNewPhoto: bm 뽑는 부분@@@@@@@@@@@@@@@@");
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Log.d(TAG, "uploadNewPhoto: 성공시 NEW photo.@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
    ...
    //OriginalPhoto
    public void uploadOriginalPhoto(String photoType, final String imgUrl, Bitmap bm) {
        Log.d(TAG, "uploadNewPhoto: attempting to upload new photo.");
        FilePaths filePaths = new FilePaths();
        //case1) new photo
        if (photoType.equals(mContext.getString(R.string.new_photo))) {
            ...
            String user_id = FirebaseAuth.getInstance().getCurrentUser().getUid();
            final StorageReference storageReference = mStorageReference
                    .child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/Original_photo" );
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Uri downloadUrl = uri;
                            String firebaseUrl = downloadUrl.toString();
                            FilterActivity.setOriginalPhoto(firebaseUrl);
        ...
        //case new profile photo
            ...
            Log.d(TAG, "uploadOriginNewPhoto: uploading new PROFILE photo.");

            String user_id = FirebaseAuth.getInstance().getCurrentUser().getUid();
            final StorageReference storageReference = mStorageReference
                    .child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/Original_profile_photo");
...
//    private void setOriginalPhoto(String url) {
//        Log.d(TAG, "setOriginalPhoto: setting original image: " + url);
//
